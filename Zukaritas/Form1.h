...
#pragma endregion
		   ...
		   // el boton 1 es de buscar vehículo todo esto de abajito el show igual
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		
		Form^ buscarVehiculo = gcnew Form();
		buscarVehiculo->Text = "Buscar Vehículo";
		buscarVehiculo->Size = System::Drawing::Size(400, 300);
		buscarVehiculo->Show();//<<<<<--------
	}
		   // el boton 2 es de agregar vehículo abajito tambien ahi esta el show
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		
		Form^ agregarVehiculo = gcnew Form();
		agregarVehiculo->Text = "Agregar Vehículo";
		agregarVehiculo->Size = System::Drawing::Size(400, 300);
		agregarVehiculo->Show();//<<<<<------------
	}


		   // el boton 3 es de distribución vehículos :v
	private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
		
		Form^ distribucionVehiculos = gcnew Form();
		distribucionVehiculos->Text = "Distribución de Vehículos";
